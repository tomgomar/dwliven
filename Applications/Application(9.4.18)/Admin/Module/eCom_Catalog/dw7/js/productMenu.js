...
productMenu.deleteProduct = function (before, after) {
    ...
    var check = function (callback) {
        ...
        new Ajax.Request("/Admin/Module/eCom_Catalog/dw7/Edit/EcomUpdator.aspx?CMD=ProductList.CheckForGroups&prodCollection=" + selectedValues, {
            method: 'post',
            onSuccess: function (transport) {
    ...
    var del = function (callback) {
        new Ajax.Request("/Admin/Module/eCom_Catalog/dw7/Edit/EcomUpdator.aspx?CMD=ProductList.DeleteMultipleProductsFormList&prodCollection=" + selectedValues, {
            method: 'post',
            onSuccess: function (transport) {
                var msg = transport.responseText.toString().trim().toLowerCase();
                if (msg !== '') {
