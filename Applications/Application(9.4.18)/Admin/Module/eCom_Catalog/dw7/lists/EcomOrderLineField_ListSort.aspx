<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EcomOrderLineField_ListSort.aspx.vb" Inherits="Dynamicweb.Admin.eComBackend.EcomOrderLineField_ListSort" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        function save() {
            new Ajax.Request("/Admin/Module/eCom_Catalog/dw7/lists/EcomOrderLineField_ListSort.aspx", {
                method: 'post',
                parameters: {
                    "OrderLineFields": Sortable.sequence('items').join(','),
                    "Save": "save"
                },
                onSuccess: cancel
            });
        ...
        function cancel() {
            window.location.href = "/Admin/Module/eCom_Catalog/dw7/lists/EcomOrderLineField_List.aspx";
        }
    </script>
</head>
<body class="screen-container">
    <div class="card">
        <div class="card-header">
            <h2 class="subtitle"><%=Translate.Translate("Sort order lines")%></h2>
        </div>
        <form id="form1" runat="server">
            ...
            <div class="list">
                <asp:Repeater ID="OrderLineFieldsRepeater" runat="server" EnableViewState="false">
                    <HeaderTemplate>
                        <ul class="list-group">
                    ...
                    <ItemTemplate>
                        <li class="list-group-item" id="OrderLineField_<%#Eval("SystemName")%>">
