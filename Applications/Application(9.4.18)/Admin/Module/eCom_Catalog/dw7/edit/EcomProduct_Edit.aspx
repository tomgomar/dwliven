...
<asp:content id="Header" contentplaceholderid="HeadHolder" runat="server">
    ...
    function changeImgType(mMode, picID, mType) {
        ...
        function gotoVariant(prodId, groupID, variantId, found, callback) {
            ...
            var variantPage = "EcomProduct_Edit.aspx?ID="+ encodeURIComponent(prodId) +"&GroupID="+ groupID +"&VariantID="+ variantId + "&Found=" + found + "&ecom7master=hidden&updateSimpleVariant=true";
...
var _MetaKeywordsCounterMaxId = '<%=MetaKeywordsCounterMax.ClientID%>';
        ...
        function updateStockRow(rowId){
            if(validateRow(rowId)){
                ...
                var rowCells = $$('#' + rowId + ' td');
                rowCells[0].update('<span style="margin-left:5px;">' + (($('DdlStockLocation').value == '0') ? "" : $('DdlStockLocation')[$('DdlStockLocation').selectedIndex].text) + '</span>');
                rowCells[1].update('<span style="margin-left:5px;">' + $('DdlUnit')[$('DdlUnit').selectedIndex].text + '</span>');
                rowCells[2].update('<span style="margin-left:5px;">' + variantText + '</span>');
                rowCells[3].update('<span style="margin-left:5px;">' + $('nsAmount').value + '</span>');
                rowCells[4].update('<span style="margin-left:5px;">' + $('nsVolume').value + '</span>');
                rowCells[5].update('<span style="margin-left:5px;">' + $('nsWeight').value + '</span>');
                $('UpdateRowID').value = "";
        ...
        function addStockRow(){
            if(validateRow()){
                ...
                tr.insert(new Element('td').update('<span style="margin-left:5px;">' + variantText + '</span>')); 
        ...
        function UpdateProductImage(size) {            
            ...
            switch (size) {
                ...
                case 1:
                    ...
                    if (largeImage.value || mediumImage.value) {
                        return;
                    } else {
                            ...
                            <div id="Tab1" class="Tab1Div" style="display: none">
                                <dwc:GroupBox ID="primaryProductSettings" runat="server">
                                    <div class="row">
                                        ...
                                        <div class="card-section-4 <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductActive)%>">
                                        ...
                                        <div class="card-section-8">
                                            <div class="row <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductName, ProductDataBaseField.ProductNumber) %>" >
                                                <div class="card-section-12">
                                                    <div class="form-group <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductName)%>" >
                                                    ...
                                                    <div class="form-group <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductNumber)%>" >
                                            ...
                                            <div class="row">
                                                <div class="card-section-6 <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductPrice, ProductDataBaseField.ProductStock) %> ">
                                                    <div class="form-group <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductPrice)%>">
                                                    ...
                                                    <div class="form-group <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductStock)%>">
                                                ...
                                                <div class="card-section-6 <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductDefaultPoints, ProductDataBaseField.ProductManufacturerId) %> ">
                                                    ...
                                                    <div class="form-group <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductDefaultPoints)%>" >
                                                    ...
                                                    <%End If%>
                                                    <div class="form-group box-control <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductManufacturerId)%> ">
                                            ...
                                            <div class="row <%= GetCommonFieldCssClass(FieldElementsSection.ShortDescription) %>">
                                                <div class="card-section">
                                                    <div class="form-group full-width short-descr">
                                            ...
                                            <div class="row <%= GetCommonFieldCssClass(FieldElementsSection.Settings, ProductDataBaseField.ProductLongDescription) %>" >
                                                <div class="card-section-seperator"></div>
                                                <div class="card-section">
                                                    <div class="form-group full-width long-descr">
                                ...
                                <dwc:GroupBox Title="Stock" IsCollapsed="True" DoTranslation="false" runat="server" ID="StockGroupBox">
                                    <table class="formsTable">
                                        ...
                                        <tr class="<%= GetCommonFieldCssClass(FieldElementsSection.Stock, ProductDataBaseField.ProductWeight)%>">
                                            ...
                                            <td>
                                                <asp:TextBox ID="Weight" Width="40" CssClass="NewUIinput" runat="server" />
                                        ...
                                        <tr class="<%= GetCommonFieldCssClass(FieldElementsSection.Stock, ProductDataBaseField.ProductVolume)%>">
                                            ...
                                            <td>
                                                <asp:TextBox ID="Volume" Width="40" CssClass="NewUIinput" runat="server" />
                                ...
                                <dwc:GroupBox Title="Advanced configurations" IsCollapsed="True" runat="server">
                                    <table class="formsTable">
                                        ...
                                        <tr class="<%= GetCommonFieldCssClass(FieldElementsSection.AdvancedConfigurations, ProductDataBaseField.ProductCost)%>">
                                            ...
                                            <td>
                                                <asp:TextBox ID="Cost" Width="80" CssClass="NewUIinput" Style="text-align: right" runat="server">
                                                </asp:TextBox>&nbsp;<asp:Label ID="CurrencyLabelCost" runat="server"></asp:Label>
