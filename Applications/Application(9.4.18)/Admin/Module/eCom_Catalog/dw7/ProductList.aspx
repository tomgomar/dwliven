...
<asp:Panel runat="server" ID="ContentPanel">
    ...
    <dw:ContextMenu ID="ProductContext" runat="server">
        ...
        <dw:ContextMenuButton ID="ContextMenuButton1" runat="server" Divide="Before" Icon="Check" IconColor="Default" OnClientClick="productMenu.activateProduct();" Text="Activate" />
        <dw:ContextMenuButton ID="ContextMenuButton2" runat="server" Icon="Times" IconColor="Default" OnClientClick="productMenu.deactivateProduct();" Text="Deactivate" />
