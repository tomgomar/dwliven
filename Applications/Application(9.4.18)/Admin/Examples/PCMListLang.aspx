<%@ Page Language="vb" AutoEventWireup="false" ValidateRequest="false" CodeBehind="PCMListLang.aspx.vb" Inherits="Dynamicweb.Admin.PCMListLang" %>
...
<head>
    ...
    <style>
        ...
        .pcm-list-item-missing-translation {
            border-left: 4px solid #FFC107;
            border-right: 4px solid #FFC107;
            width: calc(100% - 8px);
        }

        .pcm-list-item-missing-translation .pcm-list-title .form-control {
                    ...
                    <div class="pcm-list">
                        <div class="row row-spacing">
                            <div class="section-6 section-spacing">
                                <div class="pcm-list-action-header">
                                     <span class="flag-icon flag-icon-gb pcm-list-action-header-flag"></span>
                                     <div class="pcm-list-action-header-title">English</div>
                                </div>
                            ...
                            <div class="section-6 section-spacing">
                                <div class="pcm-list-action-header">
                                      <span class="flag-icon flag-icon-dk pcm-list-action-header-flag"></span>
                                      <div class="pcm-list-action-header-title">Dansk</div>
                                      <div class="pcm-list-action-header-warning"><i class="fa fa-exclamation-triangle"></i></div>
                                </div>
                                ...
                                <div class="pcm-list-item">
                                    <div class="row">
                                        <div class="pcm-list-left section-9">
                                            <div class="pcm-list-check">
                                                <dwc:CheckBox ID="CheckBox4" Name="CheckBox1" runat="server" />
                                            </div>
                                            <button class="btn pcm-list-edit-btn"><i class="fa fa-pencil"></i></button>
                                            <div class="pcm-thumb"><img class="img-responsive" src="/Admin/Public/GetImage.ashx?width=100&amp;height=70&amp;crop=0&amp;Compression=75&amp;image=/Files/Images/Ecom/Products/10096.jpg"></div>
                                            <div class="pcm-list-info">
                                                <div class="pcm-list-title">
                                                    <dwc:InputText runat="server" Placeholder="Title" Value="Mit flotte nye produkt er alt hvad jeg mangler"></dwc:InputText>
                                                </div>
                                                <div class="pcm-list-description js-pcm-list-description" data-id="description4">
                                                    Jeg kan virkelig godt lide det her produkt...
                                                </div>
                                            </div>
                                        </div>
                                        <div class="pcm-list-right section-3">
                                    ...
                                    <div class="row">
                                        <div class="pcm-list-description-edit collapsed" id="description4">
                                            <div class="pcm-list-description-edit-field" style="visibility: hidden">
                                                <dwc:InputTextArea runat="server" Placeholder="Description" Value="Jeg kan virkelig godt li det"></dwc:InputTextArea>
                                            </div>
                                        </div>
                                        <div class="pcm-list-footer">
                                            <div class="row">
                                ...
                                <div class="pcm-list-item">
                                    <div class="row">
                                        <div class="pcm-list-left section-9">
                                            <div class="pcm-list-check">
                                                <dwc:CheckBox ID="CheckBox5" Name="CheckBox2" runat="server" />
                                            </div>
                                            <button class="btn pcm-list-edit-btn"><i class="fa fa-pencil"></i></button>
                                            <div class="pcm-thumb"><img class="img-responsive" src="/Admin/Public/GetImage.ashx?width=100&amp;height=70&amp;crop=0&amp;Compression=75&amp;image=/Files/Images/Ecom/Products/10097.jpg"></div>
                                            <div class="pcm-list-info">
                                                <div class="pcm-list-title">
                                                    <dwc:InputText runat="server" Placeholder="Title" Value="Endu et fint produkt"></dwc:InputText>
                                                </div>
                                                <div class="pcm-list-description js-pcm-list-description" data-id="description5">
                                                    This is the text about the product...
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="pcm-list-description-edit collapsed" id="description5">
                                            <div class="pcm-list-description-edit-field" style="visibility: hidden">
                                                <dwc:InputTextArea runat="server" Placeholder="Description" Value="I really like this fine product very much"></dwc:InputTextArea>
                                            </div>
                                        </div>
                                ...
                                <div class="pcm-list-item pcm-list-item-missing-translation">
                                    <div class="row">
                                        <div class="pcm-list-left section-9">
                                            <div class="pcm-list-check">
                                                <dwc:CheckBox ID="CheckBox6" Name="CheckBox3" runat="server" />
                                            </div>
                                            <button class="btn pcm-list-edit-btn"><i class="fa fa-pencil"></i></button>
                                            <div class="pcm-thumb"><i class="fa fa-exclamation-circle"></i></div>
                                            <div class="pcm-list-info">
                                                ...
                                                <div class="pcm-list-description js-pcm-list-description" data-id="description6">
                                                    Read about it now...
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="pcm-list-description-edit collapsed" id="description6">
                                            <div class="pcm-list-description-edit-field" style="visibility: hidden">
                                                <dwc:InputTextArea runat="server" Placeholder="Description" Value="I really like this fine product very much"></dwc:InputTextArea>
                                            </div>
                                        </div>
