        ...
        <dw:RibbonBar ID="areaRibbon" runat="server">
            <dw:RibbonBarTab ID="RibbonBarTab1" runat="server" Name="Website">
                ...
                <dw:RibbonBarGroup ID="RibbonbarGroup2" runat="server" Name="Tools">
                    <dw:RibbonBarButton ID="cmdSortAreas" runat="server" OnClientClick="location='Sort.aspx';" Icon="Sort" Size="Small" Text="Sort">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="cmdEditArea" runat="server" Active="false" Disabled="false" Size="Small" Icon="Pencil" Text="Rediger" OnClientClick="edit();">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="cmdDeleteArea" runat="server" Icon="Delete" Size="Small" Text="Delete" OnClientClick="deleteAreaBtn();">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="cmdCopyArea" runat="server" Icon="ContentCopy" Size="Small" Text="Kopier" OnClientClick="copyDialog();">
                    </dw:RibbonBarButton>
                    <dw:RibbonBarButton ID="cmdAreaPermissions" runat="server" Text="Permissions" Icon="Lock" Size="Small" OnClientClick="openAreaPermissions();" />
                </dw:RibbonBarGroup>
