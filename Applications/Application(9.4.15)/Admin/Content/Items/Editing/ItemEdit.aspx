    ...
    <body class="screen-container">
        <div class="card">
           ...
           <dwc:ActionBar runat="server">
                <dw:ToolbarButton runat="server" Text="Gem" Size="Small" Image="NoImage" KeyboardShortcut="ctrl+s" OnClientClick="Dynamicweb.Items.ItemEdit.get_current().save();" ID="cmdSave" ShowWait="false">
                </dw:ToolbarButton>
                <dw:ToolbarButton runat="server" Text="Gem og luk" Size="Small" Image="NoImage" OnClientClick="Dynamicweb.Items.ItemEdit.get_current().saveAndClose();" ID="cmdSaveAndClose" ShowWait="false">
                </dw:ToolbarButton>
                <dw:ToolbarButton runat="server" Text="Annuller" Size="Small" Image="NoImage" OnClientClick="Dynamicweb.Items.ItemEdit.get_current().cancel();" ID="cmdCancel" ShowWait="true" WaitTimeout="500">
                </dw:ToolbarButton>
            </dwc:ActionBar>
            </form>
        </div>
