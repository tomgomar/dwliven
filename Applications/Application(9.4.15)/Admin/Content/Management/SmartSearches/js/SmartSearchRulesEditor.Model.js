...
Dynamicweb.Controls.SmartSearch.SmartSearchRulesEditor.DateTimeCtrl = function (id, val, nameOfMonths, onChange, showTime, showDynamicValues, terminology) {
    ...
    var convertToDate = function (stringValue, format) {
        ...
        return terminology.Never;
    }

    var dateSelectorOnChange = function (e) {
        var el = this;
        ...
        if (value.charAt(0) == '@' || value.toLowerCase() == "never" || value == "") {            
            onChange(value);
            timeCtrl.disabled = true;
        } else if (isNotSet.toLowerCase() === 'true') {
            onChange(terminology.Never)
            timeCtrl.disabled = true;
        } else {
    ...
    if (id != "") {
        ...
        '    <div class="fg-line">' +
        '        <span id="' + id + '_label" class="std DateSelectorLabel form-control">' + displayedDate + '</span>' +
