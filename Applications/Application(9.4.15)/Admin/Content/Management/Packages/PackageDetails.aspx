            ...
            <dwc:Card runat="server">
                ...
                <dwc:CardBody runat="server">
                    ...
                    <dwc:GroupBox runat="server" ID="PackageInformation" Title="Information">
                        ...
                        <div>
                            <button runat="server" type="submit" id="InstallButton" name="InstallButton" onclick="showOverlay()" class="btn btn-flat" value="1"><i class="<%=KnownIconInfo.ClassNameFor(KnownIcon.Download, True, KnownColor.Primary)%>"></i> <dw:TranslateLabel runat="server" Text="Install" /></button>
                            <button runat="server" type="submit" id="UpdateButton" name="UpdateButton" onclick="showOverlay()" class="btn btn-flat" value="1"><i class="<%=KnownIconInfo.ClassNameFor(KnownIcon.Refresh, True)%>"></i> <dw:TranslateLabel runat="server" Text="Update" /></button>
                            <button runat="server" type="submit" id="UninstallButton" name="UninstallButton" onclick="showOverlay()" class="btn btn-flat" value="1"><i class="<%=KnownIconInfo.ClassNameFor(KnownIcon.Remove, True)%>"></i> <dw:TranslateLabel runat="server" Text="Uninstall" /></button>
                            <button runat="server" type="submit" id="RestoreButton" visible="false" name="RestoreButton" onclick="showOverlay()" class="btn btn-flat" value="1"><i class="<%=KnownIconInfo.ClassNameFor(KnownIcon.Restore, True)%>"></i> <dw:TranslateLabel runat="server" Text="Restore" /></button>
                        </div>
                    </dwc:GroupBox>
                </dwc:CardBody>
            </dwc:Card>
