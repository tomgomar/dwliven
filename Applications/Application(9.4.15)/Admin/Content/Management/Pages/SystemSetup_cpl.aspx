...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    <dwc:Card runat="server">
        <dwc:CardHeader runat="server" Title="System setup" />
        <dwc:CardBody runat="server">
            ...
            <dwc:GroupBox runat="server" ID="groupbox4" Title="Active Directory" Visible="false">
                <%If Dynamicweb.Configuration.SystemConfiguration.Instance.GetValue("/Globalsettings/Modules/Users/UseExtendedComponent") = "True" Then
                        Dynamicweb.Configuration.SystemConfiguration.Instance.SetValue("/Globalsettings/Modules/Users/UseExtendedComponent", "False")
                    End If
                %>
                <dwc:InputText runat="server" ID="ActiveDirectoryAdsiDomain" Name="/Globalsettings/System/ActiveDirectory/ADSI-Domain" Label="ADSI-Domain" MaxLength="255" />
                <dwc:InputText runat="server" ID="ActiveDirectoryAdsiDomain2" Name="/Globalsettings/System/ActiveDirectory/ADSI-Domain2" Label="ADSI-Domain 2" MaxLength="255" />
                <dwc:InputText runat="server" ID="ActiveDirectoryUserName" Name="/Globalsettings/System/ActiveDirectory/UserName" Label="Brugernavn" MaxLength="255" />
                <dwc:InputText runat="server" ID="ActiveDirectoryPassword" Name="/Globalsettings/System/ActiveDirectory/Password" Label="Adgangskode" MaxLength="255" Password="true" />
            </dwc:GroupBox>
