...
<body class="area-green screen-container">
    <div class="card">
        <form id="EditGroupForm" runat="server">
            <dw:RibbonBar ID="Ribbon" runat="server">
                <dw:RibbonBarTab ID="RibbonbarTab1" runat="server" Active="true" Name="Default">
                    ...
                    <dw:RibbonBarGroup ID="RibbonbarGroup3" runat="server" Name="Settings">
                        ...
                        <dw:RibbonBarButton runat="server" ID="CommPermissionsButton" Visible="False" Text="Permissions" OnClientClick="popupCommPermissions(true);" Size="Small" Icon="EnvelopeO" />
            ...
            <dw:Dialog ID="ValidationEmailDialog" runat="server" Title="Invalid email addresses" HidePadding="true" ShowOkButton="false" ShowCancelButton="true" ShowClose="true" Width="800" CancelAction="OnCloseValidationEmailPopUp();dialog.hide('ValidationEmailDialog');">
