	        ...
	        if (globalGroupId.length > 0) {
	            ...
	            if (fieldName == "relatedGroupsChecked") {
	                ...
	                if (enableClick) {
	                    ...
	                    dialog.show('GroupEditMiscDialog', "/Admin/module/ecom_catalog/dw7/edit/EcomGroupTree.aspx?CMD=ShowGroupGroupRel&MasterGroupID=" + globalGroupId + "&MasterShopID=" + globalShopId + "&caller=" + caller);
                    }
                }
                else {
                    var caller = "parent.document.getElementById('Form1')." + fieldName;
                    dialog.setTitle('GroupEditMiscDialog', '<%=Translate.Translate("Add product relation")%>');
                dialog.show('GroupEditMiscDialog', "EcomGroupTree.aspx?CMD=ShowGroupProdRel&caller=" + caller + "&RelgrpID=" + RelgrpID + "&GroupID=" + globalGroupId);
            }
        }
        else {
