...
<dwc:DialogLayout runat="server" ID="PermissionEdit" Title="Permissions" HidePadding="True">
    <Content>
        <div class="col-md-0">
            <dw:GroupBox runat="server" ID="divPermissions" Title="Permissions" DoTranslation="false">
                <asp:Repeater ID="PermissionsRepeater" runat="server" EnableViewState="false">
                    ...
                    <ItemTemplate>
                        <div class="row">                            
                            ...
                            <div class="col-sm-1">
                                <div class="radio">                                    
                                    <input type="radio" value="<%# PermissionLevel.None %>" id="<%# "None_" & CType(Container.DataItem, UnifiedPermission).UserId %>" name="permissionLevel<%# CType(Container.DataItem, UnifiedPermission).UserId %>" <%# if(CType(Container.DataItem, UnifiedPermission).Permission = PermissionLevel.None, "checked='checked'", "") %> /><label for="<%# "None_" & CType(Container.DataItem, UnifiedPermission).UserId %>"></label>
                                </div>
                            </div>
                            <div class="col-sm-1">
                                <div class="radio">
                                    <input type="radio" value="<%# PermissionLevel.Read %>" id="<%# "Read_" & CType(Container.DataItem, UnifiedPermission).UserId %>" name="permissionLevel<%# CType(Container.DataItem, UnifiedPermission).UserId %>" <%# if(CType(Container.DataItem, UnifiedPermission).Permission = PermissionLevel.Read, "checked='checked'", "") %> /><label for="<%# "Read_" & CType(Container.DataItem, UnifiedPermission).UserId %>"></label>
                                </div>
                            </div>
                            <div class="col-sm-1">
                                <div class="radio">
                                    <input type="radio" value="<%# PermissionLevel.Edit %>" id="<%# "Edit_" & CType(Container.DataItem, UnifiedPermission).UserId %>" name="permissionLevel<%# CType(Container.DataItem, UnifiedPermission).UserId %>" <%# if(CType(Container.DataItem, UnifiedPermission).Permission = PermissionLevel.Edit, "checked='checked'", "") %> /><label for="<%# "Edit_" & CType(Container.DataItem, UnifiedPermission).UserId %>"></label>
                                </div>
                            </div>
                            <div class="col-sm-1">
                                <div class="radio">
                                    <input type="radio" value="<%# PermissionLevel.Create %>" id="<%# "Create_" & CType(Container.DataItem, UnifiedPermission).UserId %>" name="permissionLevel<%# CType(Container.DataItem, UnifiedPermission).UserId %>" <%# if(CType(Container.DataItem, UnifiedPermission).Permission = PermissionLevel.Create, "checked='checked'", "") %> /><label for="<%# "Create_" & CType(Container.DataItem, UnifiedPermission).UserId %>"></label>
                                </div>
                            </div>
                            <div class="col-sm-1">
                                <div class="radio">
                                    <input type="radio" value="<%# PermissionLevel.Delete %>" id="<%# "Delete_" & CType(Container.DataItem, UnifiedPermission).UserId %>" name="permissionLevel<%# CType(Container.DataItem, UnifiedPermission).UserId %>" <%# if(CType(Container.DataItem, UnifiedPermission).Permission = PermissionLevel.Delete, "checked='checked'", "") %> /><label for="<%# "Delete_" & CType(Container.DataItem, UnifiedPermission).UserId %>"></label>
                                </div>
                            </div>
                            <div class="col-sm-1">
                                <div class="radio">
                                    <input type="radio" value="<%# PermissionLevel.All %>" id="<%# "All_" & CType(Container.DataItem, UnifiedPermission).UserId %>" name="permissionLevel<%# CType(Container.DataItem, UnifiedPermission).UserId %>" <%# if(CType(Container.DataItem, UnifiedPermission).Permission = PermissionLevel.All, "checked='checked'", "") %> /><label for="<%# "All_" & CType(Container.DataItem, UnifiedPermission).UserId %>"></label>
                                </div>
                            </div>
                ...
                <div id="newPermissionRowTemplate" style="display: none">
                    ...
                    <div class="col-sm-1">
                        <div class="radio">
                            <input type="radio" value="1" name="permissionLevel__UserId__" checked="checked"><label for=""></label>
                        </div>
                    </div>
                    <div class="col-sm-1">
                        <div class="radio">
                            <input type="radio" value="4" name="permissionLevel__UserId__"><label for=""></label>
                        </div>
                    </div>
                    <div class="col-sm-1">
                        <div class="radio">
                            <input type="radio" value="20" name="permissionLevel__UserId__"><label for=""></label>
                        </div>
                    </div>
                    <div class="col-sm-1">
                        <div class="radio">
                            <input type="radio" value="84" name="permissionLevel__UserId__"><label for=""></label>
                        </div>
                    </div>
                    <div class="col-sm-1">
                        <div class="radio">
                            <input type="radio" value="340" name="permissionLevel__UserId__"><label for=""></label>
                        </div>
                    </div>
                    <div class="col-sm-1">
                        <div class="radio">
                            <input type="radio" value="1364" name="permissionLevel__UserId__"><label for=""></label>
                        </div>
                    </div>
                    <div class="col-sm-2 colRemove">
                        <i title="Remove row" class="fa fa-remove color-danger" onclick="removeUsersAndGroupPermission(this);"></i>
    ...
    <Footer>
        <button class="btn btn-link waves-effect" type="button" onclick="Action.Execute({'Name':'Submit'})"><dw:TranslateLabel runat="server" Text="Save and close" /></button>
