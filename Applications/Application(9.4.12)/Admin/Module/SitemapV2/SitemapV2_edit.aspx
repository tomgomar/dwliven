...
<dw:ModuleSettings ID="ModuleSettings1" runat="server" ModuleSystemName="SitemapV2" Value="Menu, AreaID, PageSelected, FirstLevel, LastLevel, IncludeAllPages, Template, UseOwnStyles, <%=StyleSettings()%>" />
