...
<body class="area-black screen-container">
    <dwc:Card runat="server">
        <form id="form1" runat="server">
            ...
            <dw:Dialog runat="server" ID="editConditionals" ShowOkButton="true" ShowCancelButton="true" Title="Edit conditionals" Size="Medium" OkAction="stopConfirmation();$('action').value='editConditionals';$('form1').submit();">
                <div id="editConditionalsDiv"></div>
            </dw:Dialog>

            <dw:Dialog runat="server" ID="addConditional" ShowOkButton="true" ShowCancelButton="true" Title="Add conditionals" Size="Medium" OkAction="stopConfirmation();$('action').value='addConditional';$('form1').submit();">
                <select runat="server" id="addConditionalColumn" name="addConditionalColumn" class="std condition-column"></select>
                <select runat="server" id="addConditionalOperator" class="std condition-operator">
                ...
                <input type="text" id="addCondition" class="std condition-text" name="addCondition" />
            </dw:Dialog>
