...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).observe('dom:loaded', function () {
            ...
            dwGrid_FieldsGrid.onRowAddedCompleted = function() {
                debugger;
                var propCtrl = document.getElementById("ProductProperties");
                productPropertiesChanged(propCtrl);
            };
        });
        ...
        function checkUsage() {
            ...
            function productPropertiesChanged(ctrl) {
                var arr = document.querySelectorAll(".hide-field-if-empty input[type=checkbox]");
