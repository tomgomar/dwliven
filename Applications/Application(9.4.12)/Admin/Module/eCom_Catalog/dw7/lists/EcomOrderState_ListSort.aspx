...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function cancel() {
            window.location.href = "/Admin/Module/eCom_Catalog/dw7/lists/EcomOrderState_List.aspx?flowId=" + <%=FlowId()%> + "<%=If(IsQuotes, "&OrderType=quotes", "")%>";
        }
    </script>
</head>
<body class="screen-container">
    <div class="card">
        <div class="card-header">
            <h2 class="subtitle"><%=If(IsQuotes, Translate.Translate("Sort quote state"), Translate.Translate("Sort order state"))%></h2>
        </div>
