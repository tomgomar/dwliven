...
<body class="area-green screen-container">
    <div class="card">
            <form id="UserListForm" runat="server">
                    ...
                    <dw:List ID="UserList" runat="server" AllowMultiSelect="true" Title="Users" Personalize="true" NoItemsMessage="No users"
                ...
                <dw:ContextMenu ID="UserContext" runat="server">
                    ...
                    <%End If%>
                    <%If GroupID > 0 Then%>
                        <dw:ContextMenuButton ID="ContextMenuButton2" runat="server" Divide="Before" Icon="PlusSquare" Text="Ny_bruger" OnClientClick="__context.newUser();" />
                    <%End If%>
	            ...
	            <dw:Contextmenu ID="GeneralContext" runat="server">
	                <dw:ContextmenuButton ID="cmdNewUserGeneral" runat="server" Divide="None" Icon="PlusSquare" Text="Ny_bruger" OnClientClick="__context.newUser();" />
	            </dw:Contextmenu>
