...
function AccessibilityCheckboxClick(checkbox) {
    var originalCheckboxId = checkbox.id.substring(0, checkbox.id.length - 1);
    document.getElementById(originalCheckboxId).checked = checkbox.checked;
}
