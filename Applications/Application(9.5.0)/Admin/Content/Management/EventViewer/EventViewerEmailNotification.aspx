            ...
            <dwc:Card runat="server">
                ...
                <dwc:CardBody runat="server">
                    <dwc:GroupBox ID="DatabaseGroupBox" runat="server" Title="Database information" GroupWidth="6">
                        ...
                        <dwc:CheckBoxGroup runat="server" ID="notificationLevel" Name="/Globalsettings/Settings/EventViewer/NotificationLevel" Label="Notification levels"></dwc:CheckBoxGroup>
                        <dwc:CheckBoxGroup runat="server" ID="notificationCategory" Name="/Globalsettings/Settings/EventViewer/NotificationCategory" Label="Notification categories"></dwc:CheckBoxGroup>
