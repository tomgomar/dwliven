...
<head runat="server">
    ...
    <script type="text/javascript" src="js/Deployment.min.js"></script>
        ...
        <div class="screen-container">
            ...
            <dwc:Card ID="output" runat="server">
                ...
                <dw:Toolbar ID="toolbar1" runat="server" ShowAsRibbon="true">
                    <dw:ToolbarButton runat="server" Text="Transfer selected" ID="cmdTransfer" Icon="Exchange" OnClientClick="TransferButtonClicked();" Disabled="true" ShowWait="true" WaitTimeout="500">
                    </dw:ToolbarButton>
                </dw:Toolbar>
