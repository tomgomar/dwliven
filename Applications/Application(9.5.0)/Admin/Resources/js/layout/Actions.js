...
(function () {
    ...
    Action.openWindowWithVerb= function(verb, url, data, target) {
    ...
    Action.ShowPermissions = function (action, model) {
        ...
        Action.OpenDialog({
            Url: "/Admin/Content/Permissions/PermissionEdit.aspx?Key={Key}&Name={Name}&SubName={SubName}&Title={Title}&AvailableLevels={AvailableLevels}"
        }, model);
    ...
    var privateMethods = {
        ...
        dialog: {
            ...
            getDialog: function (dlgLevel, create) {
                ...
                dlgDoc.getElementById("dialog-frame-" + dlgLevel).addEventListener("load", function (e) {
