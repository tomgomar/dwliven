<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EcomTrackAndTrace_List.aspx.vb" Inherits="Dynamicweb.Admin.eComBackend.EcomTrackAndTrace_List" %>
        ...
        <form id="form1" runat="server" enableviewstate="false">
            ...
            <dw:List ID="List1" runat="server" Title="" ShowTitle="false" StretchContent="false" PageSize="25">
                ...
                <Columns>
                    ...
                    <dw:ListColumn ID="colURL" runat="server" Name="URL" EnableSorting="true" />
                </Columns>
            </dw:List>
