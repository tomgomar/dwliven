<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EcomPayment_ListSort.aspx.vb" Inherits="Dynamicweb.Admin.eComBackend.EcomPayment_ListSort" %>
...
<head runat="server">
    ...
    <script type="text/javascript">
        ...
        function save() {
            new Ajax.Request("/Admin/Module/eCom_Catalog/dw7/lists/EcomPayment_ListSort.aspx", {
                method: 'post',
                parameters: {
                    "Payments": Sortable.sequence('items').join(','),
                    "Save": "save"
                },
                onSuccess: cancel
            });
        ...
        function cancel() {
            window.location.href = "/Admin/Module/eCom_Catalog/dw7/lists/EcomPayment_List.aspx";
        }
    </script>
</head>
<body class="screen-container">
    <div class="card">
        <div class="card-header">
            <h2 class="subtitle"><%=Translate.Translate("Sort payments")%></h2>
        </div>
        <form id="form1" runat="server">
            ...
            <div class="list">
                <asp:Repeater ID="ProductsRepeater" runat="server" EnableViewState="false">
                    ...
                    <ItemTemplate>
                        <li class="list-group-item" id="Payment_<%#Eval("ID")%>">
