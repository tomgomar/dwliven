<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="EcomOrderFlow_List.aspx.vb" Inherits="Dynamicweb.Admin.eComBackend.EcomOrderFlow_List" %>
        ...
        <form id="form1" runat="server" enableviewstate="false">
            ...
            <dw:List ID="List1" runat="server" Title="" ShowTitle="false" StretchContent="false" PageSize="25">
                ...
                <Columns>
                    ...
                    <dw:ListColumn ID="colIsDefault" runat="server" Name="Standard" EnableSorting="true" Width="300" />
                </Columns>
            </dw:List>
