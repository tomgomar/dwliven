...
<dwc:GroupBox runat="server" ID="SettingsGroupbox" Title="Settings">
    <dwc:CheckBox runat="server" ID="CreateNonExistingProperties" Label="Create non-existing Property Fields" Visible="false" />
    <dwc:CheckBox runat="server" ID="CreateNonExistingLanguageProducts" Label="Create non-existing languages" />
</dwc:GroupBox>
<dwc:GroupBox runat="server">
    <table class="formsTable">
        <tr>
