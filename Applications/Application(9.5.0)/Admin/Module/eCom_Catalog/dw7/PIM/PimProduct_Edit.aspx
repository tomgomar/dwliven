...
<body class="area-red">
    <div class="overlay-container" id="screenLoaderOverlay" style="display:none"><div class="overlay-panel"><i class="fa fa-refresh fa-3x fa-spin"></i></div></div>
    <div class="screen-container">
        <div class="card">
            <ecom:Form ID="Form1" runat="server">
                <div class="pcm-content">
                    ...
                    <dw:RibbonBar ID="PCMRibbon" runat="server">
                        ...
                        <dw:RibbonBarTab ID="WorkflowTab" Active="false" Name="Versioning" runat="server">
                            <dw:RibbonBarGroup Name="Tools" runat="server">
                                <dw:RibbonBarButton ID="btnSaveProduct2" Text="Save" Icon="Save" Size="Small" runat="server" ShowWait="true" OnClientClick="Dynamicweb.PIM.BulkEdit.get_current().save();" />
                                <dw:RibbonBarButton ID="btnSaveAndCloseProduct2" Text="Save and close" Icon="Save" Size="Small" runat="server" ShowWait="true" OnClientClick="Dynamicweb.PIM.BulkEdit.get_current().save(true);" />
                                <dw:RibbonBarButton ID="BtnCancel2" Text="Cancel" Icon="TimesCircle" IconColor="Default" Size="Small" runat="server" ShowWait="true" OnClientClick="Dynamicweb.PIM.BulkEdit.get_current().cancel();" />
                            </dw:RibbonBarGroup>
                ...
                <dw:Dialog runat="server" Title="Add distribution channel groups" ID="RelatedEcomGroupsDialog" Size="Large" ShowOkButton="True" OkAction="Dynamicweb.PIM.BulkEdit.get_current().closeRelatedGroupsDialog(false);">
                    <%=GetRelatedEcomGroups() %>
                </dw:Dialog>

                <dw:Dialog runat="server" Title="Related PIM warehouse groups" ID="RelatedPimGroupsDialog" Size="Large" ShowOkButton="True" OkAction="Dynamicweb.PIM.BulkEdit.get_current().closeRelatedGroupsDialog(true);">
                    <%=GetRelatedPimGroups() %>
                </dw:Dialog>
            ...
            <dw:Dialog ID="SelectImageGroupDialog" runat="server" Title="Assign to image category" ShowOkButton="true" ShowCancelButton="true" ShowClose="true" OkAction="Dynamicweb.PIM.BulkEdit.get_current().assignImageGroup();">
                <dwc:GroupBox runat="server">
                    <dwc:SelectPicker ID="ImageGroupPicker" runat="server" Label="Image category"></dwc:SelectPicker>
                </dwc:GroupBox>
            </dw:Dialog>
        </div>
    </div>
