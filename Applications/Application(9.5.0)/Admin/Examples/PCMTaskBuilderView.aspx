<%@ Page Language="vb" AutoEventWireup="false" ValidateRequest="false" CodeBehind="PCMTaskBuilderView.aspx.vb" Inherits="Dynamicweb.Admin.PCMTaskBuilderView" %>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="pcm-action-bar">
                        ...
                        <button class="btn btn-flat pcm-success-btn pull-right" onclick="changePage('/Admin/Examples/PCMTaskBuilderFilters.aspx')">Show included fields <i class="fa fa-angle-right"></i></button>
                        <button class="btn btn-flat m-r-15 pull-right" onclick="changePage('/Admin/Examples/PCMTaskBuilderOverview.aspx')">No, thanks! <i class="fa fa-angle-double-right"></i></button>
                    </div>
                </div>
